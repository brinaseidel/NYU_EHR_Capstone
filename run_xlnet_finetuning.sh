...
#SBATCH --gres=gpu:5
#SBATCH --output=/gpfs/data/razavianlab/capstone19/logs/xlnet_large_finetune_full_256.log
...
python xlnet_finetuning.py --model_id xlnet_finetune_full_256_v2 --batch_size 32 --num_train_epochs 3 --seed 100 --fp16 --train_logging_step 1000 --val_logging_step 20000 --save_step 100000 --feature_save_dir full_256 --model_type "large"
