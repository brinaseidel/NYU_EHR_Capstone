...
def main():
    ...
    feature_save_path = '/gpfs/data/razavianlab/ehr_transformer_xlnet' + set_type
    ...
    torch.save(all_input_ids , feature_save_path + '_input_ids.pt')
    torch.save(all_input_mask , feature_save_path + '_input_mask.pt') 
    torch.save(all_segment_ids , feature_save_path + '_segment_ids.pt')
    torch.save(all_label_ids , feature_save_path + '_labels.pt')
